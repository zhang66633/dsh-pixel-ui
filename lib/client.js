...
/* 页签：选中态金色下划线 */\r
html[data-pixel-ui] [class*='tab'],\r
html[data-pixel-ui] [aria-selected='true'] {\r
  font-size: 12px;\r
}\r
html[data-pixel-ui] [class*='tab'][class*='active'],\r
html[data-pixel-ui] [aria-selected='true'] {\r
...
html[data-pixel-ui] [contenteditable='true']:focus {\r
  ...
  box-shadow:\r
    inset 3px 3px 0 rgba(0, 0, 0, 0.6),\r
    0 0 0 2px var(--px-gold),\r
    0 0 8px rgba(244, 208, 63, 0.4) !important;\r
}\r
...
html[data-pixel-ui] [class*='Sidebar'] {\r
  background-image: linear-gradient(180deg, var(--px-wood-warm) 0%, var(--px-wood-dark) 100%) !important;\r
  border-bottom: 3px solid #000 !important;\r
  box-shadow:\r
    inset 0 2px 0 rgba(244, 208, 63, 0.1),\r
    inset 0 -2px 0 rgba(0, 0, 0, 0.5) !important;\r
}\r
html[data-pixel-ui] [class*='sidebar'],\r
html[data-pixel-ui] [class*='Sidebar'] {\r
  border-right: 3px solid #000 !important;\r
  box-shadow:\r
    inset -3px 0 0 rgba(0, 0, 0, 0.4),\r
    inset 2px 0 0 rgba(255, 255, 255, 0.05) !important;\r
}\r
\r
/* ── 链接：金色下划线 ──────────────────────────────────── */\r
...
html[data-pixel-ui] body::after {\r
  ...
  background:\r
    repeating-linear-gradient(\r
      0deg,\r
      rgba(0, 0, 0, 0.1) 0px,\r
      rgba(0, 0, 0, 0.1) 1px,\r
      transparent 1px,\r
      transparent 3px\r
    ),\r
    radial-gradient(ellipse at center, transparent 62%, rgba(0, 0, 0, 0.22) 100%);\r
...
.px-theme-btn-active {\r
  color: #1A0F06;\r
  background: #F4D03F;\r
  border-color: #8B6B00;\r
  box-shadow:\r
    inset 1px 1px 0 #FFE066,\r
    inset -1px -1px 0 #8B6B00,\r
    2px 2px 0 rgba(0, 0, 0, 0.5);\r
}\r
.px-theme-swatch {\r
  width: 10px;\r
