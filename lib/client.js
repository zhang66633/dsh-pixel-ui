...
html[data-pixel-ui] [class*='Sidebar'] {\r
  ...
  border-right: 4px solid #000 !important;\r
  box-shadow:\r
    inset 3px 0 0 var(--px-wood-pale),\r
    inset -4px 0 0 rgba(0, 0, 0, 0.55),\r
    6px 0 0 rgba(0, 0, 0, 0.45),\r
    9px 0 0 rgba(0, 0, 0, 0.22) !important;\r
}\r
\r
